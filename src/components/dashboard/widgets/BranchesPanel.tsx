...
function BranchCard({ branch, onDetails, onEdit }: { branch: any; onDetails: (b: any) => void; onEdit: (b: any) => void }) {
  ...
  return (
    <div className="glass-panel rounded-2xl p-6 flex flex-col gap-2 border border-blue-100 dark:border-blue-800 transition cursor-pointer group min-w-[270px] max-w-xs aspect-square justify-between" onClick={() => onDetails(branch)}>
      <div>
